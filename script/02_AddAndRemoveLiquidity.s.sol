...
import {FedzSwapRouter} from "../src/FedzSwapRouter.sol";
...
// forge script AddLiquidityScript --private-key 0x534012a5d0a91ea1f7902203f7f5c29fffcde18d439a28c48f0c6d9eb18521ab --rpc-url https://arbitrum.rpc.subquery.network/public
contract AddLiquidityScript is Script, StdCheats {
    ...
    function run() external {
        ...
        FedzModifyLiquidityRouter fedzModifyLiquidityRouter = new FedzModifyLiquidityRouter(address(TheFedzHook));
        FedzSwapRouter fedzSwapRouter = new FedzSwapRouter(address(TheFedzHook));
        TheFedzHook.setFedzPool(address(fedzModifyLiquidityRouter), address(fedzSwapRouter));
        ...
        // IPoolManager.ModifyLiquidityParams memory params = IPoolManager.ModifyLiquidityParams(-600, 600, 2, 0);
        ...
        // });
        // vm.prank(player);
        // IERC20(token0).approve(address(fedzSwapRouter), 1);
        // vm.prank(player);
